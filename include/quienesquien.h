...
private:
    ...
    /**
     * @brief arbol_mejorado flag que indica si se debería llamar al método crear_arbol (si vale false) o si se debería llamar al método crear_arbol_mejorado (si vale true)
    */
    bool arbol_mejorado;
	...
	/**
	  ...
	  * 	   Este método debe crear el árbol eligiendo las preguntas en orden.
	  */
	 ...
	 /**
	  * @brief Esta es una propuesta de cabecera de la función para crear el arbol.
	  *        Este método implementa la mejora de creación del árbol donde las preguntas se escogen maximizando la entropía
	  *        (es decir, intentando que el árbol esté balanceado).
	  */
...
public:
	...
	*/
     ...
     * @param m: True si se desea crear el árbol de manera mejorada, false en caso contrario
     */
